...
<head>
        ...
        <!-- Title -->
        <title>Institute of Information Technology & Yoga
</title>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url()?>apanel/index" class="logo-name text-lg text-center">iity Admin login</a>
                                ...
                                <p class="text-center m-t-xs text-sm">2019&copy; Gfinch Technologies.</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
