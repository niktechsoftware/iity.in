...
<body class="home page-menu-top-vertical  html front not-logged-in no-sidebars page-home">
<div class="site">
    <!-- Start Header -->
...
-->
	<li  class="first expanded"><a href="<?php echo base_url();?>" class="active">Home</a></li>
	<li  class="expanded"><a href="#">About Us</a><ul class="sub-menu">	
	<li><a href="<?php echo base_url()?>index.php/welcome/aboutUs" title="">About IITY</a></li>
	<li><a href="<?php echo base_url()?>index.php/welcome/mission" title="">Misson of IITY</a></li>
	<li><a href="<?php echo base_url()?>index.php/welcome/vision" title="">Vision Of IITY</a></li>
	</ul></li>
	<li><a href="<?php echo base_url()?>index.php/welcome/aim_object" title="">Aim & Objective</a></li>
	<li  class="expanded"><a href="#">Courses</a><ul class="sub-menu">
	<li><a href="<?php echo base_url()?>index.php/welcome/diploma" title="">Advance Diploma In Computer Application (ADCA)
	</a></li>
<li><a href="<?php echo base_url()?>index.php/welcome/diploma" title="">Certificate In Computer Application (CCA)</a></li>
<li><a href="<?php echo base_url()?>index.php/welcome/diploma" title="">Course on Computer concept (CCC)</a></li>
<li><a href="<?php echo base_url()?>index.php/welcome/diploma" title="">Yoga Teachers Training (YTT)</a></li>
</ul></li>
...
<!-- END / HEADER MENU -->  </div>
    ...
    <!-- End Header -->
              ...
              <div class="region region-banner" style="margin-top: -25px;">
    	<div class="block block-revslider"  id="block-revslider-1">
...
<div class="tp-bannertimer"></div>
  ...
  <div class="panel-panel panel-col">
    <div><div class="panel-pane pane-views pane-about"  >
          ...
          <div class="container-boxed max">
              <div class="col-md-8 col-sm-12">
                  <hr class="noo-gap noo-gap-100">
                      ...
                      <h2 class="custom-title"><span>Welcome to </span>Institute of Information Technology & Yoga</h2>
                      	<p>The main aim of our institution is to look into the overall growth of a student apart form computer education. What they learn in their home, school and colleges is not enough to survive in this globalized world. Hence the Institute prepares students in all aspects to face the challenges in both professional as well as personal life. Our Institution is committed to provide quality education to students by providing appropriate infrastructure and qualified Faculties. It is our deep desire that students enrich knowledge, inculcate culture of learning and develop capability to compete for jobs in global scenario.
                      	</p>
                <p>A training organization that will empower young to acquire best opportunities to join modern work force.
               Contribute in the development of the nation through quality education technology. Services and Courses Offered.
                </p> </div>
                 <div class="view view-about view-id-about view-display-id-default_about view-dom-id-69b440d9c98b469291c42d4e9de17b64">
    ...
    <div class="noo-text-block">
        <a href="#">BALANCE BODY AND MIND <i class="fa fa-chevron-circle-right"></i></a>
    </div>
</div>            <div class="col-sm-4 col-md-4 col-sm-6">
    <span class="noo-icon">
        <i class="fa fa-suitcase"></i>
    </span>
    <div class="noo-text-block">
        <a href="#">HEALTHY DAILY LIFE <i class="fa fa-chevron-circle-right"></i></a>
    </div>
</div>            <div class="col-sm-4 col-md-4 col-sm-6">
    <span class="noo-icon">
    ...
    <div class="noo-text-block">
        <a href="#">YOGA MONTH CHALLENGE <i class="fa fa-chevron-circle-right"></i></a>
    </div>
</div>    </div>    </div>
...
</div>                  <hr class="noo-gap noo-gap-100">
              </div>
               <div class="col-md-4 col-sm-6">
       <!--     <a href="#" target="_blank"> <img src="<?php echo base_url();?>assets/webimage/webmail.png" alt="Vinyasa Class"/></a>-->
      <hr class="noo-gap noo-gap-100">
      <div style="height: 100%; width:100%; max-width:400px; padding-top: 8px; padding-bottom: 15px; margin: 1px; background: #f9fffd; border: 1px solid #0288cc; border-radius: 15px;  -moz-border-radius: 15px;  -webkit-border-radius: 15px;">
  <H2><center>Notice Board</center></H2>
<hr />
...
<div class="panel-separator"></div><div class="panel-pane pane-views pane-class"  >
    
    	<div class="row our-class-section"  style="background-color:#f4f4f4;">
        <div class="col-md-12"  >
        <div class="container-boxed max">
                <div class="row our-class-header">
                    <div class="col-md-12">
                        <div class="text-block">
                          <center><h2 class="custom-title"><span>Our </span>Courses</h2></center>
                                                    </div>
                    </div>
                </div>
              </div>
                ...
                <div class="row our-class-content">
                    <div class="view view-class view-id-class view-display-id-default_class view-dom-id-857c5929c89159bd21146eb1cf506d8c">
    ...
    <div class="noo-rn-content default">
     ...
     <div class="item-wrap">
        <div class="item-featured">
            <a href="#" title="Vinyasa Class">
                <img src="<?php echo base_url();?>assets/sites/default/files/class_10.jpg" alt="Vinyasa Class"/>
            </a>
        </div>
        <div class="item-content">
            <h3 class="item-title">
                <a href="<?php echo base_url()?>index.php/welcome/ADCA" title="">Code:ADCA </a>
            </h3>
            <div class="info">
                <span class="time"><span class="date-display-single" property="dc:date" datatype="xsd:dateTime" content="2015-08-18T12:00:00+07:00">Duration Twelve Months</span></span>
                <span>	Eligibility : <em>High School</em></span>
                <span>	Fee : <em>4800</em></span>
            </div>
            <div class="learn-more">
                <a class="btn-darker" href="#" title="Learn more">Learn more </a>
            </div>
        </div>
    </div>
</div>                          
    ...
    <div class="item-wrap">
        <div class="item-featured">
            <a href="#" title="Basic Kundalini">
                <img src="<?php echo base_url();?>assets/sites/default/files/class_14.jpg" alt="Basic Kundalini"/>
            </a>
        </div>
        <div class="item-content">
            <h3 class="item-title">
                <a href="<?php echo base_url()?>index.php/welcome/CCA" title="">Code:CCA</a>
            </h3>
            <div class="info">
                <span class="time"><span class="date-display-single" property="dc:date" datatype="xsd:dateTime" content="2015-08-27T11:00:00+07:00">Duration Six Months<span></span>
                <span>Eligibility :<em>High School</em></span>
                <span>	Fee : <em>3000</em></span>
            </div>
            <div class="learn-more">
                <a class="btn-darker" href="#" title="Learn more">Learn more </a>
            </div>
...
<div class="loop-item col-sm-3">
    <div class="item-wrap">
        <div class="item-featured">
            <a href="#" title="Basic Kundalini">
                <img src="<?php echo base_url();?>assets/sites/default/files/class_12_0.jpg" alt="Basic Kundalini"/>
            </a>
        </div>
        <div class="item-content">
            <h3 class="item-title">
                <a href="<?php echo base_url()?>index.php/welcome/CCC" title="">Code:CCC</a>
            </h3>
            <div class="info">
                <span class="time"><span class="date-display-single" property="dc:date" datatype="xsd:dateTime" content="2015-08-27T11:00:00+07:00">Duration Three Months<span></span>
                <span>Eligibility :<em>High School</em></span>
                <span>	Fee : <em>3000</em></span>
            </div>
            <div class="learn-more">
...
<div class="loop-item col-sm-3">
    <div class="item-wrap">
        <div class="item-featured">
            <a href="#" title="Basic Kundalini">
                <img src="<?php echo base_url();?>assets/sites/default/files/class_10.jpg" alt="Basic Kundalini"/>
            </a>
        </div>
        <div class="item-content">
            <h3 class="item-title">
...
<div class="panel-pane pane-views pane-trainer"  >
    
        	<div  style="background-color:#ffffff;">
            <div class="container-boxed max">
                <div class="row best-trainer-section">
                    <div class="col-md-12">
                        <div class="loop-item col-sm-12" style="background: #f9fffd; border: 1px solid #0288cc; border-radius: 15px;  -moz-border-radius: 15px;  -webkit-border-radius: 15px;">
    <h2 class="custom-title"><span>History Of </span>Yoga</h2>
       <p><strong>Yoga:</strong> the trendy practice that your hippie, hipster, or fitness friends rave about. Garbed in yoga pants and carrying colorful mats bought off Amazon, the modern-day “yogi” attends one-hour classes that focus on physical stretching, movement, and detoxing from their busy modern lives. We hear a lot about the benefits of yoga, from its ability to decrease stress, chronic pain, as well as the risk for chronic diseases like obesity, diabetes, and heart disease. </p>
    <p>What we don’t hear about as often, however, is the history of yoga. Most people are aware of its Indian spiritual and religious roots, but those tend to get washed out by the manufactured, commoditized versions of yoga we see today. Perhaps that’s because research on yoga’s origins is hard to find, and its history is a complicated, lengthy narrative. In fact, yoga is incredibly complex — even the word "yoga" has taken on hundreds of different meanings and practices throughout the years. What you and I might assume is “yoga” is probably not even closely related to what yoga was thousands of years ago.</p>
</div>     
...
<div class="panel-pane pane-panels-mini pane-new-video-topic"  >
            ...
            <div class="row">
                <div class="col-md-12">
                    <hr class="noo-gap noo-gap-50">
                                                              <div class="text-block">
                        <h2 class="custom-title"><span>new video </span>topics</h2>
                                              </div>
                                                            <div class="videos posts-loop slider">
                        <div class="posts-loop-content row">
                            <div class="panel-display panel-2col clearfix" id="mini-panel-new_video_topic">
  <div class="col-sm-6">
    <div class="panel-pane pane-views pane-blog"  >
    
    	<div class="view view-blog view-id-blog view-display-id-video_list_blog view-dom-id-4a00b8e3e512023b76b31c41ff882532">
        ...
        <div class="loop-thumb-content">
            <div class="carousel slide fade">
                <div class="carousel-inner">
							...
							<a href="#" data-target="#videos-content" data-slide-to="0">
								<span class="icon">
	<i class="fa fa-play"></i>
</span>
Become an Yoga trainer at Yogi center<span class="thumbnail-content">Yoga is a physical, mental, and spiritual practice or discipline....</span>                            </a>
                        </div>
                                                                    <div class="item active">
							<a href="#" data-target="#videos-content" data-slide-to="1">
								<span class="icon">
	<i class="fa fa-play"></i>
</span>
Sky Flow from Sunchaser<span class="thumbnail-content">Yoga is a physical, mental, and spiritual practice or discipline....</span>                            </a>
                        </div>
                                                                    <div class="item active">
							<a href="#" data-target="#videos-content" data-slide-to="2">
								<span class="icon">
	<i class="fa fa-play"></i>
</span>
Spirit Yoga Tutorial<span class="thumbnail-content">Yoga is a physical, mental, and spiritual practice or discipline....</span>                            </a>
                        </div>
                                                            </div>
            </div>
        </div>
  ...
  <div class="col-sm-6">
    <div class="panel-pane pane-views pane-blog"  >
    	...
    	<div class="view view-blog view-id-blog view-display-id-video_thumb_blog view-dom-id-7ead3907d1d78420b53fc3d25bab9f8f">
        
  
  
      <div class="view-content">
      <div id="videos-content" class="video carousel slide fade">
    <div class="carousel-inner">
                                <article class="item active">
							<div class="loop-item-wrap">
    <div class="loop-item-featured">
        <div id="file-23--2" class="file file-video file-video-vimeo">

        <h2 class="element-invisible"><a href="files/patagonia-yoga.html">Patagonia Yoga</a></h2>
    
  
  <div class="content">
    <div class="media-vimeo-video media-vimeo-3">
  <iframe class="media-vimeo-player" width="640" height="360" title="Patagonia Yoga" src="http://player.vimeo.com/video/54411625?color="  allowfullscreen>Video of Patagonia Yoga</iframe>
</div>
  </div>
    ...
    <div class="loop-item-content">
        ...
        <h2 class="loop-item-title">
            <a href="#" title="Become an Yoga trainer at Yogi center">Become an Yoga trainer at Yogi center</a>
        </h2>
        <div class="loop-item-excerpt">
            Yoga is a physical, mental, and spiritual practice or discipline....        </div>
    </div>
</div>            </article>
                                            <article class="item">
            				<div class="loop-item-wrap">
    <div class="loop-item-featured">
        <div id="file-24--2" class="file file-video file-video-youtube">

        <h2 class="element-invisible"><a href="#">30 Days of Yoga - Start Here</a></h2>
    
  
  <div class="content">
    <div class="media-youtube-video media-youtube-2">
  <iframe class="media-youtube-player" width="640" height="390" title="30 Days of Yoga - Start Here" src="http://www.youtube.com/embed/TXU591OYOHA?wmode=opaque"  allowfullscreen>Video of 30 Days of Yoga - Start Here</iframe>
</div>
  </div>
    ...
    <div class="loop-item-content">
        <span class="icon"><i class="fa fa-play"></i></span>
        <h2 class="loop-item-title">
            <a href="#" title="Sky Flow from Sunchaser">Sky Flow from Sunchaser</a>
        </h2>
        <div class="loop-item-excerpt">
            Yoga is a physical, mental, and spiritual practice or discipline....        </div>
    </div>
            				...
            				<div class="loop-item-wrap">
    <div class="loop-item-featured">
        <div id="file-25--2" class="file file-video file-video-vimeo">

        <h2 class="element-invisible"><a href="#">Spirit Yoga</a></h2>
    
  
  <div class="content">
    <div class="media-vimeo-video media-vimeo-4">
  <iframe class="media-vimeo-player" width="640" height="360" title="Spirit Yoga" src="http://player.vimeo.com/video/67860545?color="  allowfullscreen>Video of Spirit Yoga</iframe>
</div>
  </div>
    ...
    <div class="loop-item-content">
        <span class="icon"><i class="fa fa-play"></i></span>
        <h2 class="loop-item-title">
            <a href="#" title="Spirit Yoga Tutorial">Spirit Yoga Tutorial</a>
        </h2>
        <div class="loop-item-excerpt">
            Yoga is a physical, mental, and spiritual practice or discipline....        </div>
    </div>
...
<div>
    ...
    <div class="address">
                    <ul>
                                	                    <li><i class="fa fa-map-marker"></i> A-109 FIRST FLOOR, JP TOWER, VIKASH KHAND-1 INDIRAPURAM (NCR REGION) GHAZIABAD-201014(U.P.)</li>


                                	                    <li><i class="fa fa-phone"></i>Mobile :+919455755635 </li>
                                	                    <li><i class="fa fa-envelope"></i>info@iity.com</li>
        ...
        <div class="widget">
									...
									<ul><li>
											...
											<span>Yoga can have numerous benefits for people with epilepsy. Namely, reducing stress and helping one feel more empowered and in control of their body.We are ... 
												<a href="#" title="" target="_blank">http://IITY.com</a>
											</span>
										</li>
										<li>
        ...
        <div class="container-full">
            <div class="footer-more">
                <div class="container-boxed">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="noo-bottom-bar-content">Copyright © 2018. IITY All rights reserved
                            <h3><span>Niktech Software Solution</span></h3>
                        </div>
                        </div>
                    </div>
                </div>
